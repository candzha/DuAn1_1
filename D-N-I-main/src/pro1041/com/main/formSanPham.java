...
public class formSanPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        rdo100150 = new javax.swing.JRadioButton();
        rdo050 = new javax.swing.JRadioButton();
        rdo50100 = new javax.swing.JRadioButton();
        rdo150200 = new javax.swing.JRadioButton();
        ...
        buttonGroup2.add(rdo100150);
        rdo100150.setText("100-150");
        rdo100150.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdo100150ActionPerformed(evt);
            }
        });

        buttonGroup2.add(rdo050);
        rdo050.setText("0-50");
        rdo050.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdo050ActionPerformed(evt);
            }
        });

        buttonGroup2.add(rdo50100);
        rdo50100.setText("50-100");
        rdo50100.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdo50100ActionPerformed(evt);
            }
        });

        buttonGroup2.add(rdo150200);
        rdo150200.setText("150-200");
        rdo150200.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdo150200ActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtTimKiemSPCT, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(3, 3, 3)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(rdo050)
                                .addGap(18, 18, 18)
                                .addComponent(rdo50100)
                                .addGap(18, 18, 18)
                                .addComponent(rdo100150, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(rdo150200, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rdo050)
                    .addComponent(rdo50100)
                    .addComponent(rdo100150)
                    .addComponent(rdo150200))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void rdo100150ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdo100150ActionPerformed
        if (rdo100150.isSelected()) {
            dssp = sanPhamService.fillALL100150();
        } else {
            dssp = sanPhamService.getAll();
        }
        showDuLieu();
    }//GEN-LAST:event_rdo100150ActionPerformed

    private void rdo050ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdo050ActionPerformed
        if (rdo050.isSelected()) {
            dssp = sanPhamService.fillALL050();
        } else {
            dssp = sanPhamService.getAll();
        }
        showDuLieu();
    }//GEN-LAST:event_rdo050ActionPerformed

    private void rdo50100ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdo50100ActionPerformed
        if (rdo50100.isSelected()) {
            dssp = sanPhamService.fillALL50100();
        } else {
            dssp = sanPhamService.getAll();
        }
        showDuLieu();
    }//GEN-LAST:event_rdo50100ActionPerformed

    private void rdo150200ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdo150200ActionPerformed
        if (rdo150200.isSelected()) {
            dssp = sanPhamService.fillALL150200();
        } else {
            dssp = sanPhamService.getAll();
        }
        showDuLieu();
    }//GEN-LAST:event_rdo150200ActionPerformed

    private void txtTimKiemSPCTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemSPCTKeyPressed
        String tim = txtTimKiemSPCT.getText();
        Search2(tim);
    }//GEN-LAST:event_txtTimKiemSPCTKeyPressed

    private void txtTimKiemSPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemSPKeyPressed
        String tim = txtTimKiemSP.getText();
        Search1(tim);
    ...
    private void Search2(String tim) {
        DefaultTableModel model = (DefaultTableModel) tblSanPham.getModel();
        TableRowSorter<DefaultTableModel> tableRowSorter = new TableRowSorter<>(model);
        tblSanPham.setRowSorter(tableRowSorter);

        List<RowFilter<Object, Object>> filters = new ArrayList<>();
        filters.add(RowFilter.regexFilter("(?i)" + tim));

        filters.add(RowFilter.regexFilter("(?i)" + tim, 0));
    ...
    public void Search1(String tim) {
        DefaultTableModel model = (DefaultTableModel) tblSanPhamChinh.getModel();
        TableRowSorter<DefaultTableModel> tableRowSorter = new TableRowSorter<>(model);
        tblSanPhamChinh.setRowSorter(tableRowSorter);
    ...
    private javax.swing.JRadioButton rdo050;
    private javax.swing.JRadioButton rdo100150;
    private javax.swing.JRadioButton rdo150200;
    private javax.swing.JRadioButton rdo50100;
