...
public class formNhanVien extends javax.swing.JPanel {
    ...
    private void taoMa() {
     ...
     public void loadTBTimKiem() {
        ...
        List<NhanVien> lstNV = nhanVienService.timkiem(id);
      ...
      public void loadAllNhanVien() {
        List<NhanVien> lstNV = nhanVienService.getAll();
        model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        btnTimKiemSanPham.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnTimKiemSanPhamKeyPressed(evt);
            }
        });
    ...
    private void btnTimKiemSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemSanPhamActionPerformed
        ...
        if (!id.matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "ID phải là một số nguyên dương");
            return;
        }
        nhanVienService.timkiem(id);
        loadTBTimKiem();
    }//GEN-LAST:event_btnTimKiemSanPhamActionPerformed

    private void btnTimKiemSanPhamKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnTimKiemSanPhamKeyPressed

    }//GEN-LAST:event_btnTimKiemSanPhamKeyPressed
