...
public class SanPhamService {
    ...
    public List<SanPham> fillALL050() {
        String sql = """
                    SELECT 
                                             spc.id_SPCT,
                                                 sp.id_sanPham,
                                             ...
                                             JOIN 
                                                ...
                                                JOIN 
                                                KhoaAo ka ON spc.id_khoaAo = ka.id_khoaAo
                                             WHERE spc.soluongtonkho BETWEEN 0 AND 50
...
public List<SanPham> fillALL50100() {
        String sql = """
                    SELECT 
                                             spc.id_SPCT,
                                                 sp.id_sanPham,
                                             ...
                                             JOIN 
                                                ...
                                                JOIN 
                                                KhoaAo ka ON spc.id_khoaAo = ka.id_khoaAo
                                             WHERE spc.soluongtonkho BETWEEN 50 AND 100
...
public List<SanPham> fillALL100150() {
        String sql = """
                    SELECT 
                                             spc.id_SPCT,
                                                 sp.id_sanPham,
                                             ...
                                             JOIN 
                                                ...
                                                JOIN 
                                                KhoaAo ka ON spc.id_khoaAo = ka.id_khoaAo
                                             WHERE spc.soluongtonkho BETWEEN 100 AND 150
...
public List<SanPham> fillALL150200() {
        String sql = """
                    SELECT 
                                             spc.id_SPCT,
                                                 sp.id_sanPham,
                                             ...
                                             JOIN 
                                                ...
                                                JOIN 
                                                KhoaAo ka ON spc.id_khoaAo = ka.id_khoaAo
                                             WHERE spc.soluongtonkho BETWEEN 150 AND 200
