...
//                    nv.setEmail(rs.getString("email"));
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(null, "Lỗi khi lấy dữ liệu từ ResultSet: " + e.getMessage());
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Lỗi khi kết nối hoặc truy vấn cơ sở dữ liệu: " + e.getMessage());
        }
        return listNV;
    }
}
